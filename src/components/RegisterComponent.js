            ...
            <div className="register__wrap">
                ...
                <form className="register__form">
                    <div className="register__input">
                        <input id="register-input-login" name="login" type="text" value={login} onChange={handleInput} />
                        <label htmlFor="register-input-login">Login:</label>
                    </div>
                    <div className="register__input">
                        <input id="register-input-email" name="email" type="email" value={email} onChange={handleInput} />
                        <label htmlFor="register-input-email">E-mail:</label>
                    </div>
                    <div className="register__input">
                        <input id="register-input-password" name="password" type="password" value={password} onChange={handleInput} />
                    ...
                    <button type="submit" onClick={registerFetch}>Register</button>
                </form>
            </div>
        </div>
    </>);
